...
echo ✅ Service running on http://localhost:5500
echo 📋 To create tunnel, get new authtoken from: https://dashboard.ngrok.com/get-started/your-authtoken
echo 📋 Then run: ngrok http 5500
echo.
echo 🔧 For now, use LOCAL_CONVERSION_SERVICE_URL=http://localhost:5500 for local testing
